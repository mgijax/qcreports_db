...
print ''
print 'Find Duplicate MGI Id in the Mapping table for AD terms in the Structure table'
print ''
...
print ''
print 'Find AD Terms that do not map to EMAPS Id''s'
print ''
...
print ''
print 'Find AD Term names and EMAPS Term names that do not match'
print ''
...
print ''
print 'Find AD Stage and EMAPS Stage that are not the same'
print ''
