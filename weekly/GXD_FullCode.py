...
def processJournal(jList, fileName):
    ...
    for journalTitle in jList:
        ...
        fp.write(str.ljust('accID', 30))
        fp.write(SPACE)
        fp.write(str.ljust('markerCount', 12))
        fp.write(SPACE)
        fp.write(str.ljust('newGeneCount', 12))
        fp.write(SPACE)
        ...
        for r in results:
            fp.write(str.ljust(str(r['jnumID']), 30))
            fp.write(SPACE)
            fp.write(str.ljust(str(r['markerCount']), 12))
            fp.write(SPACE)
            fp.write(str.ljust(str(r['newGeneCount']), 12))
            fp.write(SPACE)
            fp.write(str.ljust(str(r['conditional']), 20))
            fp.write(SPACE)
...
for jList in journals:
    fileName = 'GXD_' + str.replace('and '.join(jList), ' ', '')
