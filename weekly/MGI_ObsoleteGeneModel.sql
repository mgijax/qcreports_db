...
\echo ''
\echo 'Obsolete Gene Models associated with Markers'
\echo ''
\echo 'This report lists Markers that have an association to NCBI Gene Model (ldb 59) but have no association to Entrez Gene (ldb 55)'
\echo ''
