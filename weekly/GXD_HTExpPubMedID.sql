...
select a.accid as ExperimentID, c.jnumid, p.value, t.term as evaluationstate, t2.term as experimenttype, e.name
from gxd_htexperiment e, voc_term t, voc_term t2, acc_accession a, mgi_property p, bib_citation_cache c
...
order by t2.term, t.term desc, a.accid
