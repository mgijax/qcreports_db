...
from gxd_htexperiment e, voc_term t, voc_term t2, voc_term t3, acc_accession a, mgi_property p, 
        bib_citation_cache c, bib_workflow_relevance wr
...
and c._refs_key = wr._refs_key
and wr.isCurrent = 1
and wr._relevance_key = t3._term_key
