...
def multiple_representative():
	...
	cmds.append('select f1._Fantom2_key, f1.riken_cloneid, f1.final_mgiID, f1.genbank_id, f1.riken_cluster ' + \
		'into #rep2 ' + \
		'from MGI_Fantom2 f1 ' + \
...
def no_rep_clone():
	...
	cmds.append('select distinct f1._Fantom2_key, f1.final_mgiID, f1.riken_cloneid, f1.riken_cluster ' + \
		'into #curated ' + \
		'from MGI_Fantom2 f1 ' + \
		'where f1.final_mgiID like "MGI:%" ' + \
		'and f1.riken_cloneid != "zilch" ' + \
...
def riken_report():
	...
	cmds.append('select f1._Fantom2_key, f1.riken_seqid, f1.riken_cloneid, f1.riken_cluster, f1.final_mgiID, ' + \
