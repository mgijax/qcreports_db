...
select h.*, type = "O"
into #results
from #homology2 h, radar_release..DP_EntrezGene_Info e
...
insert into #results
select h.*, type = "I"
from #homology2 h, radar_release..DP_EntrezGene_Synonym es, radar_release..DP_EntrezGene_Info e
...
select h.*, type = "?"
from #homology2 h
where not exists (select 1 from radar_release..DP_EntrezGene_Info e
where e.taxID = 9606 and h.hsymbol = e.symbol)
and not exists (select 1 from radar_release..DP_EntrezGene_Synonym es, radar_release..DP_EntrezGene_Info e
