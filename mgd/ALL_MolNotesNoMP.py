...
db.sql('select a._Allele_key, a.symbol, a.creation_date, alleleType = t.term ' + \
    'into #alleles  ' + \
    ...
    'and not exists (select 1 from VOC_Annot t ' + \
...
results = db.sql('select a._Allele_key, cDate = convert(char(10), a.creation_date, 101), a1.accID, a.alleleType, a.symbol ' + \
