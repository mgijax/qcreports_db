...
db.sql('create index specs_ct_idx1 on specstructs (_Specimen_key)', None)
db.sql('create index specs_ct_idx2 on specstructs (_EMAPA_Term_key)', None)
...
db.sql('''
        select distinct ss.laneLabel, ss.emapaTerm, ss.celltypeTerm, ss.stage, a1.accid as mgiID, a2.accid as jnumID, a2.numericPart 
