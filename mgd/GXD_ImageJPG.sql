...
select distinct a._Assay_key, i._Refs_key, a._ImagePane_key, ip._Image_key
into #assays 
...
insert into #assays 
select distinct s._Assay_key, i._Refs_key, iri._ImagePane_key, ip._Image_key
from GXD_InSituResultImage iri, GXD_InSituResult r, GXD_Specimen s, IMG_Image i, IMG_ImagePane ip 
...
select * into #final from #assays group by _ImagePane_key having count(*) > 2
go
...
print ""
print "Displayed Image Panes annotated to more than 2 assays."
print ""
