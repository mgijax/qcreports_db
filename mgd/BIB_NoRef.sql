...
select b._Refs_key, b.year, b._primary
into #refs
from BIB_Refs b
...
select b._Refs_key, b.year, b._primary, strain = 'no '
into #refs2
from #refs b
...
insert into #refs2
select b._Refs_key, b.year, b._primary, strain = 'yes'
from #refs b
...
select b.jnumID, b.pubmedID, substring(b.short_citation, 1, 75), r.year, r.strain
from #refs2 r, BIB_Citation_Cache b
