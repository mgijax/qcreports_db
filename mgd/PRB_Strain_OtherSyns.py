...
'''
#
# PRB_Strain_OtherSyns.py
#
# Report:
#       Tab-delimited file of Strains w/ Other Synonyms
#
# Usage:
#       PRB_Strain_OtherSyns.py
#
...
fp = reportlib.init(sys.argv[0], title = 'Strain Other Synonyms', outputdir = os.environ['QCOUTPUTDIR'])
